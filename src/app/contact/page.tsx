...
export default function ContactPage() {
  return (
    <div className="container-main py-6">
      ...
      <h1 className="heading-1 mb-6">संपर्क करें (Contact Us)</h1>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="card">
          ...
          <p className="mt-3 text-xs text-gray-400 dark:text-gray-500">
            * चिह्नित फ़ील्ड अनिवार्य हैं। आपके ईमेल का उत्तर 24-48 घंटों में दिया जाएगा।
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="card">
            <h2 className="heading-3 mb-3">अन्य संपर्क माध्यम (Other Ways to Reach Us)</h2>
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300">प्रतिक्रिया समय (Response Time)</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">24-48 घंटे (कार्य दिवसों में)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <h2 className="heading-3 mb-3">अक्सर पूछे जाने वाले प्रश्न (FAQ)</h2>
            <div className="space-y-3">
              <div>
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  क्या TypeHindi निःशुल्क है?
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  हाँ, TypeHindi पूर्णतः निःशुल्क है और इसका उपयोग करने के लिए किसी पंजीकरण की आवश्यकता नहीं है।
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  क्या मोबाइल पर उपयोग कर सकते हैं?
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  हाँ, TypeHindi मोबाइल-रेस्पॉन्सिव है। हालांकि, सर्वोत्तम अनुभव के लिए कंप्यूटर/लैपटॉप और भौतिक कीबोर्ड की अनुशंसा की जाती है।
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  TypeHindi पूर्णतः क्लाइंट-साइड है। आपका टाइपिंग डेटा केवल आपके ब्राउज़र (localStorage) में सहेजा जाता है और कहीं भेजा नहीं जाता।
                </p>
              </div>
            </div>
          </div>
