    ...
    <div className="flex flex-col min-h-screen">
      <section className="bg-primary-700 pt-4 pb-12 border-b border-primary-800">
        <div className="container-main">
          ...
          <div className="text-primary-100 [&_ol]:text-primary-200 [&_a]:text-primary-100 [&_span]:text-white">
          ...
          <div className="bg-white dark:bg-slate-900 border-4 border-primary-500/30 rounded-2xl p-2 sm:p-4 shadow-2xl">
            <PracticeTool />
          </div>
        </div>
      </section>

      <section className="py-12 bg-gray-50 dark:bg-slate-950 flex-grow">
        <div className="container-main max-w-5xl">
          <AdPlaceholder position="top" />

          {/* Dedicated Mangal Font SEO Section */}
          <div className="mt-8 mb-8 border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-2xl shadow-sm dark:shadow-lg overflow-hidden">
