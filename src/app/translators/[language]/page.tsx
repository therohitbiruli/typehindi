  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-4 text-sm text-gray-500">
        <Link href="/translators" className="text-blue-600 hover:underline">Translators</Link> &gt; {sourceName} to {langObj.name}
      </div>
      ...
      <div className="bg-white border border-gray-200 shadow-sm p-6 md:p-8 space-y-6">
        <h3 className="text-xl font-normal text-red-600 border-b border-gray-100 pb-2">
          {sourceHindiName} से {langObj.hindiName} टाइपिंग टूल का उपयोग कैसे करें
        </h3>
        <div className="text-sm text-gray-600 leading-relaxed space-y-3">
          <p>यह एक मुफ्त ऑनलाइन {sourceHindiName} से {langObj.hindiName} लिप्यंतरण (transliteration) टूल है। इस टूल का उपयोग करके, आप {sourceHindiName} अक्षरों को तुरंत {langObj.hindiName} लिपि में बदल सकते हैं। उदाहरण के लिए, {sourceHindiName} में <strong>"नमस्ते"</strong> टाइप करने पर यह स्वचालित रूप से संबंधित {langObj.hindiName} लिपि में परिवर्तित हो जाएगा।</p>
        ...
        <h3 className="text-xl font-normal text-blue-800 border-b border-gray-100 pb-2">मुख्य विशेषताएं (Key Features)</h3>
        <ul className="list-disc pl-5 text-sm text-gray-600 space-y-2">
          <li><strong>त्वरित रूपांतरण (Instant Conversion):</strong> जैसे ही आप स्पेसबार दबाते हैं, टेक्स्ट तुरंत बदल जाता है।</li>
          <li><strong>उपयोग में आसान:</strong> किसी जटिल फॉन्ट या सॉफ़्टवेयर को डाउनलोड या इंस्टॉल करने की आवश्यकता नहीं है।</li>
          <li><strong>ध्वन्यात्मक टाइपिंग:</strong> शब्द जैसा सुनाई देता है, ठीक वैसा ही टाइप करें।</li>
          <li><strong>एक-क्लिक कॉपी:</strong> एक क्लिक से अपने परिवर्तित {langObj.hindiName} टेक्स्ट को क्लिपबोर्ड पर कॉपी करें।</li>
        </ul>
      </div>
    </div>
  );
