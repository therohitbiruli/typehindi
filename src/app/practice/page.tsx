...
export default function PracticePage() {
  return (
    <div className="container-main py-6">
      ...
      <section className="mt-12 mb-12 bg-gray-50 dark:bg-slate-900/60 rounded-3xl p-6 sm:p-8 border border-gray-200 dark:border-slate-800">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            ...
            <a
              ...
              className="p-4 rounded-2xl bg-white dark:bg-slate-950 border border-gray-200 dark:border-slate-800 hover:border-primary-500/50 transition-all text-center flex flex-col items-center justify-center group hover:-translate-y-0.5 shadow-sm dark:shadow-none"
            >
              ...
              <span className="font-bold text-xs text-gray-900 dark:text-slate-200 group-hover:text-primary-400 transition-colors">
                {item.name}
              </span>
              <span className="text-[10px] text-gray-500 dark:text-slate-500 font-normal">
                {item.native}
              </span>
            </a>
          ))}
